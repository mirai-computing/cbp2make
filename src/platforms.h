...
class CPlatform
{
 ...
 public:
  ...
  OS_Type  OS(void) const { return m_OS_Type; }
  CString  Name(void);
  CString& Cmd_Copy(void)         { return m_Cmd_Copy; }
  CString& Cmd_Move(void)         { return m_Cmd_Move; }
  CString& Cmd_Make(void)         { return m_Cmd_Make; }
  CString& Tool_Make(void)         { return m_Tool_Make; }
  //CString& Cmd_TestFile(void)     { return m_Cmd_TestFile; }
  CString& Cmd_RemoveFile(void)      { return m_Cmd_RemoveFile; }
  CString& Cmd_ForceRemoveFile(void) { return m_Cmd_ForceRemoveFile; }
  //CString& Cmd_TestDir(void)         { return m_Cmd_TestDir; }
  CString& Cmd_MakeDir(void)      { return m_Cmd_MakeDir; }
  CString& Cmd_TestMakeDir(void)  { return m_Cmd_TestMakeDir; }
  CString& Cmd_ForceMakeDir(void) { return m_Cmd_ForceMakeDir; }
  CString& Cmd_RemoveDir(void)    { return m_Cmd_RemoveDir; }
  CString& Cmd_PrintWorkDir(void) { return m_Cmd_PrintWorkDir; }
  CString& Cmd_EvalWorkDir(void)  { return m_Cmd_EvalWorkDir; }
  CString& Cmd_ChangeDir(void)    { return m_Cmd_ChangeDir; }
  char Pd(void) const { return m_PathDelimiter; }
