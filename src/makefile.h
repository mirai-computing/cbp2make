...
class CMakefileVariable
{
 ...
 public:
  ...
  CStringList& Values(void) { return m_Values; }
  ...
  bool& Multiline(void) { return m_Multiline; }
...
class CMakefileRule
{
 private:
  ...
  bool m_Multiline;
 public:
  CString& Target(void) { return m_Target; }
  CStringList& Dependencies(void) { return m_Dependencies; }
  CStringList& Commands(void) { return m_Commands; }
  bool& Multiline(void) { return m_Multiline; }
