...
std::vector<CBuildTool *>& CToolChain::GetTools(const CBuildTool::ToolType Type)
{
 switch (Type)
 {
  default:
  case CBuildTool::btOther:
  case CBuildTool::btCount:            return m_BuildTools;
  case CBuildTool::btPreprocessor:     return (std::vector<CBuildTool *>&)m_Preprocessors;
  case CBuildTool::btAssembler:        return (std::vector<CBuildTool *>&)m_Assemblers;
  case CBuildTool::btCompiler:         return (std::vector<CBuildTool *>&)m_Compilers;
  case CBuildTool::btStaticLinker:     return (std::vector<CBuildTool *>&)m_StaticLinkers;
  case CBuildTool::btDynamicLinker:    return (std::vector<CBuildTool *>&)m_DynamicLinkers;
  case CBuildTool::btExecutableLinker: return (std::vector<CBuildTool *>&)m_ExecutableLinkers;
  case CBuildTool::btResourceCompiler: return (std::vector<CBuildTool *>&)m_ResourceCompilers;
  //case CBuildTool::btBuildManager,
 }
 return m_BuildTools;
}
