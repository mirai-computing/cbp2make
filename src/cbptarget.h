...
class CBuildTarget
{
 ...
 public:
  ...
  CString Output(void) const { return m_Output; }
  CString ObjectOutput(void) const { return m_ObjectOutput; }
  TargetType Type(void) const { return m_Type; }
  bool AutoPrefix(void) const { return m_AutoPrefix; }
  bool AutoExtension(void) const { return m_AutoExtension; }
  CString Compiler(void) const { return m_Compiler; }
  CStringList CompilerDirectories(void) const { return m_CompilerDirectories; }
  CStringList BeforeBuildCommands(void) const { return m_BeforeBuildCommands; }
  CStringList AfterBuildCommands(void) const { return m_AfterBuildCommands; }
  bool ForceBeforeBuildCommands(void) const { return m_ForceBeforeBuildCommands; }
  bool ForceAfterBuildCommands(void) const { return m_ForceAfterBuildCommands; }
  int& NameCase(void) { return m_NameCase; }
