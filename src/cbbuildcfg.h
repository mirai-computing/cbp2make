...
class CCodeBlocksBuildConfig
{
 ...
 public:
  ...
  int& QuotePathMode(void) { return m_QuotePathMode; }
  bool& NumericToolchainSuffix(void) { return m_NumericToolchainSuffix; }
  ...
  bool& MultilineOptions(void) { return m_MultilineOptions; }
  bool& IncludeDependencies(void) { return m_IncludeDependencies; }
  bool& KeepObjectDirectories(void) { return m_KeepObjectDirectories; }
  bool& KeepOutputDirectories(void) { return m_KeepOutputDirectories; }
  bool& BeQuiet(void) { return m_BeQuiet; }
  bool& BeVerbose(void) { return m_BeVerbose; }
 public:
  void Clear(void);
