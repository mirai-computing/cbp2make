...
void CGlobalVariable::Add(const CString& Name, const CString& Value)
{
 ...
 switch (field)
 {
  case 0: { m_Base = Value; break; }
  case 1: { m_Include = Value; break; }
  case 2: { m_Lib = Value; break; }
  case 3: { m_Obj = Value; break; }
  case 4: { m_Cflags = Value; break; }
  case 5: { m_Lflags = Value; break; }
  default:
  {
